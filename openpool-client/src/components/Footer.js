...
const Footer = ()=>{
    ...
    return (
      ...
      <footer className="grid place-items-center text-center bg-gray-900 text-white w-screen fixed bottom-0">
  <div className="container px-6 pt-6">
    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2">
      <div className="mb-6">
        <h5 className="uppercase font-bold mb-2.5">Marketplace</h5>
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Domain Names</a>
          </li>
          <li>
            <a href="#!" className="text-white">Music</a>
          </li>
          <li>
          ...
          <li>
            <a href="#!" className="text-white">Trading Cards</a>
          </li>
          <li>
            <a href="#!" className="text-white">Utility</a>
          </li>
          <li>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Watchlist</a>
          </li>
          <li>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Platform Status</a>
          </li>
          <li>
            <a href="#!" className="text-white">Partners</a>
          </li>
          <li>
            <a href="#!" className="text-white">Taxes</a>
          </li>
          <li>
          ...
          <li>
            <a href="#!" className="text-white">Newsletter</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Ventures</a>
          </li>
          <li>
            <a href="#!" className="text-white">Grants</a>
          </li>
        </ul>
      </div>
    </div>
